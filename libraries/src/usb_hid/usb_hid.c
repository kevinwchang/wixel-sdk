...
#define HID_JOYSTICK_INTERFACE_NUMBER 0
...
#define HID_JOYSTICK_ENDPOINT         1
#define HID_JOYSTICK_FIFO             USBF1   // This must match HID_JOYSTICK_ENDPOINT!
...
=
{
    ...
    HID_COLLECTION, HID_COLLECTION_APPLICATION,
        ...
        HID_REPORT_COUNT, 8, // 8 Joystick Buttons
        HID_REPORT_SIZE, 1,
        HID_USAGE_PAGE, HID_USAGE_PAGE_BUTTONS,
        HID_USAGE_MIN, 1,
        HID_USAGE_MAX, 8,
...
HID_JOYSTICK_IN_REPORT XDATA usbHidJoystickInput = {0, 0, 0};
